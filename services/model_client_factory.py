...
from llama_index.embeddings.zhipuai import (
    ZhipuAIEmbedding as LlamaIndexZhipuAIEmbedding,
)
from llama_index.embeddings.siliconflow import (
    SiliconFlowEmbedding as LlamaIndexSiliconFlowEmbedding,
)
